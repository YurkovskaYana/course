...
public class EachTeamItem {
    ...
    {
        return "EachTeamItem {intStadiumCapacity = "+intStadiumCapacity+", strTeamShort = "+strTeamShort+", idLeague3 = "+idLeague3+", idLeague2 = "+idLeague2+", idLeague5 = "+idLeague5+", strSport = "+strSport+", idLeague4 = "+idLeague4+", idLeague7 = "+idLeague7+", strDescriptionCN = "+strDescriptionCN+", idLeague6 = "+idLeague6+", strTeamJersey = "+strTeamJersey+", strTeamFanart2 = "+strTeamFanart2+", strTeamFanart3 = "+strTeamFanart3+", strTeamFanart4 = "+strTeamFanart4+", strStadiumDescription = "+strStadiumDescription+", strTeamFanart1 = "+strTeamFanart1+", intLoved = "+intLoved+", idLeague = "+idLeague+", idSoccerXML = "+idSoccerXML+", strTeamLogo = "+strTeamLogo+", strDescriptionSE = "+strDescriptionSE+", strDescriptionJP = "+strDescriptionJP+", strDescriptionFR = "+strDescriptionFR+", strStadiumLocation = "+strStadiumLocation+", strDescriptionNL = "+strDescriptionNL+", strCountry = "+strCountry+", strRSS = "+strRSS+", strDescriptionRU = "+strDescriptionRU+", strTeamBanner = "+strTeamBanner+", strDescriptionNO = "+strDescriptionNO+", strStadiumThumb = "+strStadiumThumb+", strDescriptionES = "+strDescriptionES+", intFormedYear = "+intFormedYear+", strInstagram = "+strInstagram+", strDescriptionIT = "+strDescriptionIT+", idTeam = "+idTeam+", strDescriptionEN = "+strDescriptionEN+", strWebsite = "+strWebsite+", strYoutube = "+strYoutube+", strDescriptionIL = "+strDescriptionIL+", idAPIfootball = "+idAPIfootball+", strLocked = "+strLocked+", strAlternate = "+strAlternate+", strTeam = "+strTeam+", strTwitter = "+strTwitter+", strDescriptionHU = "+strDescriptionHU+", strGender = "+strGender+", strDivision = "+strDivision+", strStadium = "+strStadium+", strFacebook = "+strFacebook+", strTeamBadge = "+strTeamBadge+", strLeague2 = "+strLeague2+", strLeague3 = "+strLeague3+", strLeague4 = "+strLeague4+", strLeague5 = "+strLeague5+", strDescriptionPT = "+strDescriptionPT+", strLeague6 = "+strLeague6+", strDescriptionDE = "+strDescriptionDE+", strLeague7 = "+strLeague7+", strLeague = "+strLeague+", strManager = "+strManager+", strKeywords = "+strKeywords+", strDescriptionPL = "+strDescriptionPL+"}";
    }
}
